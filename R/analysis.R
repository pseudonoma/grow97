...
#' @param combineData Defaults to `FALSE`. If `TRUE`, an additional dataframe called "all_growths"
#' will be generated by combining processed growth data from all projects.
